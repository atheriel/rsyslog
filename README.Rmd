...
**rsyslog** is not yet available on CRAN, so for now you'll have to install it
from GitHub:
...
Using **rsyslog** closely resembles using the [syslog API](http://man7.org/linux/man-pages/man3/openlog.3.html),
so it should be familiar if you have previous experience with syslog.
